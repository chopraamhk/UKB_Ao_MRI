...
tf.compat.v1.flags.DEFINE_integer('time_step', 1,
                            'Time step during deployment of LSTM.')
tf.compat.v1.flags.DEFINE_enum('seq_name', 'ao', ['ao'],
                         'Sequence name.')
tf.compat.v1.flags.DEFINE_enum('model', 'UNet-LSTM', ['UNet', 'UNet-LSTM', 'Temporal-UNet'],
                         'Model name.')
...
tf.compat.v1.flags.DEFINE_float('weight_r', 0.1,
